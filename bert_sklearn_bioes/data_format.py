...
if __name__=='__main__':
    ...
    origin_path=os.path.join(dir_path,'data/task1 test.json')
    after_transfer_path=os.path.join(dir_path,'data/task1 test after.txt')
