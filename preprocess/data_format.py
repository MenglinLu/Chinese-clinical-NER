...
if __name__=='__main__':
    ...
    origin_path=os.path.join(dir_path,'data_after/subtask1_training_afterrevise1.txt')
    after_transfer_path=os.path.join(dir_path,'data_after/subtask1_after_format.txt')
